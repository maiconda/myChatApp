...
function NewChat({allUsers, setAllUsers, allUsersStatic, setActiveChat}){
    ...
    const exitNewMessages = () => {
        document.querySelector('.newChat').style.left = '-100vh'
      } 
        ...
        <div className='newChat'>
            ...
            <div className='search-div'>
              <div className='search'>
                <input placeholder='Pesquisar' spellCheck="false" type="text" onChange={(e) => {searchUser(e.target.value)}} />
            ...
            {allUsers.map((user, index) => (
                <UserNewChat
                    ...
                    onClick={()=> setActiveChat(user.data())}
                />
            ))}
            </div>
        </div>
